...
per device (B§13.7.3). Data colour (which element carries which colour) is the next decision; the
rules it must obey are B§13.7.4's. Lands with §0.10 item 14's PR 14g.
