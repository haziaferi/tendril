...
fun AndroidWorkbenchScaffold(container: AppContainer) {
    ...
    WorkbenchScaffold(
        ...
        platformScaled = true, // `MainActivity.attachBaseContext` scaled the activity's density, windows included
        navState = navState,
        ...
        calendarContent = { onOpenPage ->
            CalendarScreen(
                ...
                reminderSheet = { entry, onDismiss -> ReminderSheet(core = container.workbenchCore, entry = entry, onDismiss = onDismiss) },
