...
| 2026-09-20 (the size count) | Shared: `pointerTypography`'s `titleLarge` at 16, `CANVAS_CONTENT_MIN_SCALE` = 12.5 ÷ 14 (the canvas embed and the mind-map card). The desktop page carries three chrome sizes; measured in `docs/critiques/desktop-type-grounds.md`. | §8 |
