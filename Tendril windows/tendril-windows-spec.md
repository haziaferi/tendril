...
| 2026-09-20 (the canvas card) | Shared (`Frames.kt`, `CanvasScreen.kt`); nothing desktop-only. The board's card measured 191 × 46 px at its fit; the hovered badges stacked at the right edge. | §8 |
