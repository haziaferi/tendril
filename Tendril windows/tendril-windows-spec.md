...
| 2026-09-19 (item 4 — the check-in, mock only) | A document change: the mock and critique, the home decided (the Journal's day page), the scales and the month deferred, nothing built. Nothing desktop-specific; the mock's frame B is the Pages workspace pane. | §8 |
