...
| 2026-09-13 (desktop layout benchmark) | Document only: `docs/benchmarks.md` §13 plans the desktop shell's revision (seven PRs, 14a–14g, decisions answered on `docs/mockups/desktop-shell.html`); §8 points at it. Nothing in `shared/` or here changes yet. | §8 |
...
`tendril-spec.md` §0.10 item 14 tracks it. Not started.*
