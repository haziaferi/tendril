...
@Database(
    entities = [
        Entry::class, Habit::class, Reminder::class, EntryCompletion::class, HabitCompletion::class, CheckIn::class,
        Page::class, Label::class, PageLabel::class, Block::class, PageFtsEntry::class, BlockFtsEntry::class,
    ...
    version = 25, // §3.2/§9.9/§5.5.1.1/§9.4 — v5 providerEventId; Canvas tables; purge tombstones; v9 reminder+completion uid; v10 §0.6.4 Entry fields + §0.6.6 habit log; v11 §0.8 step 2b dueDate binding; v12 §0.6.2 Block.mindMap; v13 §0.6.8 schema on a label; v14 §0.6.5 time_logs; v15 §0.6.11 lastReviewedAt; v16 §3.1.1 page_fts emptied so titles get indexed; v17 §0.6.12 blocks.referencedBlockUid; v18 §0.6.13 page_revisions; v19 §0.6.14 timeline end date + blockedBy; v20 B§13.8.1 entries.important → importance; v21 §0.10 item 3 measurable habits; v22 §0.10 item 4 check_ins; v23 the mind-map pass — canvas_nodes.parentId/folded/structure, page_canvases.structure; v24 S13 hue on page_databases and canvas_nodes; v25 block_fts (§10's block-level search)
...
abstract class TendrilDatabase : RoomDatabase() {
    ...
    abstract fun blockFtsDao(): BlockFtsDao
...
internal fun finishBuilding(
    ...
    builder
        ...
        .addMigrations(MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14, MIGRATION_14_15, MIGRATION_15_16, MIGRATION_16_17, MIGRATION_17_18, MIGRATION_18_19, MIGRATION_19_20, MIGRATION_20_21, MIGRATION_21_22, MIGRATION_22_23, MIGRATION_23_24, MIGRATION_24_25) // §9.10 — the declared paths, tried before any fallback
