...
@Database(
    ...
    version = 11, // §3.2/§9.9/§5.5.1.1/§9.4 — v5 providerEventId; Canvas tables; purge tombstones; v9 reminder+completion uid; v10 §0.6.4 Entry fields + §0.6.6 habit log; v11 §0.8 step 2b dueDate binding
...
internal fun finishBuilding(
    ...
    builder
        ...
        .addMigrations(MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11) // §9.10 — the declared paths, tried before any fallback
